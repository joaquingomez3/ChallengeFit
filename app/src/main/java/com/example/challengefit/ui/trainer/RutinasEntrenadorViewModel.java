...
public class RutinasEntrenadorViewModel extends AndroidViewModel {
    private MutableLiveData<List<Rutina>> mLista;

    public RutinasEntrenadorViewModel(@NonNull Application application) {
        super(application);
    }
            ...
            llamada.enqueue(new Callback<List<Rutina>>() {
                ...
                public void onResponse(Call<List<Rutina>> call, Response<List<Rutina>> response) {
                    if(response.isSuccessful() && response.body() != null){
                        ...
                        Log.e("RutinasVM", "Error en respuesta: " + response.code());
                    }
                }

                @Override
                public void onFailure(Call<List<Rutina>> call, Throwable t) {
                    Log.e("RutinasVM", "Fallo conexión: " + t.getMessage());
                }
            });
        }
    }
